...
echo "Build vps-d76f9e1c.vps.ovh.net:5000/backend:${tag}"
docker build -t vps-d76f9e1c.vps.ovh.net:5000/backend:${tag} .

echo "Push vps-d76f9e1c.vps.ovh.net:5000/backend:${tag}"
docker push vps-d76f9e1c.vps.ovh.net:5000/backend:${tag}
