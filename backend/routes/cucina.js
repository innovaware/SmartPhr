...
router.put("/ambiente/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            className: "CucinaAmbiente",
            operazione: "Modifica menù cucina ambiente" + cucina.nome,
        });
        console.log("log: ", log);
...
router.post("/ambiente/", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "CucinaAmbiente",
            operazione: "Inserimento menù cucina ambiente" + cucina.nome,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
...
router.put("/generale/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "Cucina",
            operazione: "Modifica menù " + cucinaGenerale.type == 1 ? + "Invernale " : "Estivo " + "settimana: " + cucinaGenerale.week,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
...
router.post("/generale", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "Cucina",
            operazione: "Inserimento menù " + cucinaGenerale.type == 1 ? + "Invernale " : "Estivo " + "settimana: " + cucinaGenerale.week,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
...
router.put("/documenti/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatore: dipendenti.nome + " " + dipendenti.cognome,
            operatoreID: user.dipendenteID,
            className: "Cucina" + req.body.typeDocument,
            operazione: "Modifica documento cucina " + cucina.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
...
router.post("/documenti", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "Cucina" + req.body.typeDocument,
            operazione: "Inserimento documento cucina " + cucina.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
...
router.delete("/documenti/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "Cucina" + req.body.typeDocument,
            operazione: "Eliminazione documento cucina " + cucina.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
