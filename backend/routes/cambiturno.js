...
router.post("/", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            className: "CambiTurno",
            operazione: "Inserimento cambio turno di: " + cambiturno.nome + " " + cambiturno.cognome,
        });
        console.log("log: ", log);
...
router.put("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "CambiTurno",
            operazione: "Modifica cambio turno di " + cambiturno.nome + " " + cambiturno.cognome,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
