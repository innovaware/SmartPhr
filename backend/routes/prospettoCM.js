...
router.post("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            className: "ProspettoCM",
            operazione: "Inserimento prospetto CM: " + prospettoCM.filename,
        });
        console.log("log: ", log);
...
router.put("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "ProspettoCM",
            operazione: "Modifica prospetto CM: " + prospettoCM.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
...
router.delete("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "ProspettoCM",
            operazione: "Eliminazione prospetto CM: " + prospettoCM.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
