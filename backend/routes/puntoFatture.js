...
router.post("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            className: "PuntoFatture",
            operazione: "Inserimento punto fatture " + puntoFatture.filename,
        });
        console.log("log: ", log);
...
router.put("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "PuntoFatture",
            operazione: "Modifica punto fatture " + puntoFatture.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
...
router.delete("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "PuntoFatture",
            operazione: "Eliminazione punto fatture " + puntoFatture.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
