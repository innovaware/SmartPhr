...
router.post("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            className: "AnticipoFatture",
            operazione: "Inserimento fattura: " + anticipoFatture.filename,
        });
        console.log("log: ", log);
...
router.delete("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "AnticipoFatture",
            operazione: "Eliminazione fattura: " + fatt.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
