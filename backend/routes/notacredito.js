...
router.post("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            className: "NoteCredito",
            operazione: "Inserimento nota credito: " + notacredito.filename,
        });
        console.log("log: ", log);
...
router.put("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "NoteCredito",
            operazione: "Modifica nota credito: " + notacredito.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
...
router.delete("/:id", async (req, res) => {
    try {
        ...
        const log = new Log({
            ...
            operatoreID: user.dipendenteID,
            className: "NoteCredito",
            operazione: "Eliminazione nota credito: " + notacredito.filename,
        });
        console.log("log: ", log);
        const resultLog = await log.save();
