...
@Component({
  selector: "app-dialog-cartella-clinica-altro",
  templateUrl: "./dialog-cartella-clinica-altro.component.html",
  styleUrls: ["./dialog-cartella-clinica-altro.component.css"],
})
export class DialogCartellaClinicaAltroComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogCartellaClinicaAltroComponent>,
