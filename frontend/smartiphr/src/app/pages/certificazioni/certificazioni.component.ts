...
@Component({
  ...
  styleUrls: ['./certificazioni.component.css']
})
export class CertificazioniComponent implements OnInit {
  ...
  public ProtezioneFulmini: String;
  public AllaccioReteIdrica: String;
  ...
  constructor(public messageService: MessagesService, public docService: DocumentiService,
    ...
    this.loadUser();
    this.ProtezioneFulmini = "ProtezioneFulmini";
    this.AllaccioReteIdrica = "AllaccioReteIdrica";
  }
