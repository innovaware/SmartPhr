...
export class AnticipoFattureASPComponent implements OnInit {
  ...
  constructor(
    ...
    this.anticipoFattureService
      .getAnticipoFattureAll()
      .subscribe((f: AnticipoFatture[]) => {
        this.anticipoFatture = f;
        this.dataSource = new MatTableDataSource<AnticipoFatture>(
          this.anticipoFatture
        );
          ...
          if (result == true) {
            this.anticipoFattureService
              ...
              .then((x) => {
                ...
                console.log(
                  "Anticipo cancellata this.anticipoFatture: ",
                  this.anticipoFatture
                );
              ...
              .catch((err) => {
                this.messageService.showMessageError(
                  "Errore nella cancellazione Anticipo"
                );
                console.error(err);
              });
          } else {
