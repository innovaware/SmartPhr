...
@Component({
  ...
  styleUrls: ['./autocertificazioni.component.css']
})
export class AutocertificazioniComponent implements OnInit {
  ...
  public ionizzanti: String;
  public rumore: String;
  public AltraAutocertificazione: String;
  ...
  constructor(public messageService: MessagesService, public docService: DocumentiService,
    ...
    this.loadUser();
    this.Caratteristiche = "CaratteristicheMicroclima";
    this.ionizzanti = "AssRadiazioniIonizzanti";
    this.rumore = "AssRumore";
    this.AltraAutocertificazione = "AltraAutocertificazione";
  }
