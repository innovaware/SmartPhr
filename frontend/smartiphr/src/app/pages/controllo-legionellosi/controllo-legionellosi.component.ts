...
@Component({
  selector: 'app-controllo-legionellosi',
  templateUrl: './controllo-legionellosi.component.html',
  styleUrls: ['./controllo-legionellosi.component.css']
})
export class ControlloLegionellosiComponent implements OnInit {
  ...
  public Documentazione: String;
  public CertificazioneRapportoProva: String;
  ...
  constructor(public messageService: MessagesService, public docService: DocumentiService,
    ...
    this.loadUser();
    this.CertificazioneRapportoProva = "CertificazioneRapportoProva";
